...
In the absence of a reliable foreground model some power spectrum experiments have opted for a
delay-spectrum technique to separate foreground emission from the cosmological 21\,cm signal
\citep{2012ApJ...756..165P}. This technique has also been coined ``foreground avoidance,'' because
it applies a transformation to the dataset that---under ideal circumstances---restricts the extent
of foreground contamination to a wedge-like feature in power spectrum space (see
Figure~\ref{fig:morales-foreground-wedge} for an illustration).
...
expansion $r \approx X + Y\nu$ with the appropriate coefficients $X$ and $Y$ for the relevant
redshift.
...
This foreground wedge arises under the assumption that all of the foreground emission is spectrally
smooth.
