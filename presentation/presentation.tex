...
\begin{frame}
    ...
    \begin{tikzpicture}[overlay, remember picture]
        \node[anchor=center] at (current page.center) {
            \href{run:movies/marin-sGRB-fullband.mp4} {
                \includegraphics[width=30pt]{movies/play-button}
            }
        };
    \end{tikzpicture}
...
\begin{frame}{Filtered Image}
    \begin{overprint}
        \onslide<1>
        \begin{center}
            \Wider[3em]{\includegraphics[width=\textwidth]{figures/sky-maps/peeled-sky-map-colorbar}}
        \end{center}
        \onslide<2>
        \begin{center}
...
\begin{frame}{Even--Odd Jackknife}
    ...
    \only<2>{
        \begin{center}
            \includegraphics[height=0.75\textheight]{figures/spherical-power-spectra/spherical-power-spectrum-even-odd.pdf}
        \end{center}
    }
\end{frame}
...
\begin{frame}{Day--Night Jackknife}
    \begin{center}
        \includegraphics[height=0.75\textheight]{figures/spherical-power-spectra/spherical-power-spectrum-day-night.pdf}
    \end{center}
\end{frame}
